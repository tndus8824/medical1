...
print(ss.find("공부",7))#문자열 7번째자리부터 검색시작해서 위치값출력
print(ss.rfind("공부"))
print("-"*20)
...
print(ss.index("파이썬"))
print(ss.index("재미"))
#print(ss.index("자바")) 존재하지 않을 때 에러처리

print(ss.startswith("파이썬")) #시작하는 문자열이 맞으면 True
print(ss.startswith("자바")) #시작하는 문자열이 틀리면 False

print(ss.endswith("않습니다"))#끝나는 문자열이 맞는지 True
print(ss.endswith("재미"))#끝나는 문자열이 맞는지  False